...
Nedenstående tabel \ref{tab:moscow} beskriver funktionelle krav, der stilles til applikationen synkerefleksmonitor. Nogle krav til synkerefleksmonitoren er vigtigere end andre, og de prioriteret vha. MosCow-metoden. Kravene i\textit{ Must og Should} prioriteres højest. I dette projekt bestræbes det at opfylde kravene i \textit{ Must og Should}. 
...
\begin{longtabu} to \linewidth{@{}l r X[l]@{}} %UC1%
	...
	Aktører 				&& 	Sundhedspersonale (primær)\\
	Referencer 				&& 	\\
	Samtidige forekomster  	&& 	To målinger pr. kørsel \\
...
\begin{longtabu} to \linewidth{@{}l r X[l]@{}} %UC1%
	...
	Aktører 				&& 	Sundhedspersonale (primær)\\
	Referencer 				&& 	\\
	Samtidige forekomster  	&& 	To gemme pr. kørsel \\
